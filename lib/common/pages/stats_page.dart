...
import 'package:mobile_app/common/widgets/card_bitcoind_stats.dart';
import 'package:mobile_app/common/widgets/card_error.dart';
import 'package:mobile_app/common/widgets/card_lnd_stats.dart';
import 'package:mobile_app/common/widgets/card_node_stats.dart';
  ...
  Future _fetchData() async {
    ...
    try {
      QueryResult result = await _client.query(QueryOptions(
          document: getSystemStatus, fetchPolicy: FetchPolicy.networkOnly));
